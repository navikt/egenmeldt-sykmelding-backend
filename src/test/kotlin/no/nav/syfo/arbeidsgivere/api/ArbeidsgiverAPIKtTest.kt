    ...
    describe("test arbeidsgiver api") {
        with(TestApplicationEngine()) {
            ...
            it("should get list of arbeidsgivere") {
                coEvery { arbeidsgiverService.getArbeidsgivere(any(), any(), any()) } returns listOf(Arbeidsgiverinfo("orgnummer", "juridiskOrgnummer", "", 50.0))
                with(handleRequest(HttpMethod.Get, "api/v1/arbeidsforhold") {
